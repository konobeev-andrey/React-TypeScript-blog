...
import {getCommentsPost, getPostOpen, ThunkPostType} from "./redux/postRedusers";
...
const AppContainer = compose<MdtpType & RouteComponentProps> (
    withRouter,
    connect<null, MdtpType,null,StateType >(null, {getPostsData,getCommentsPost, getPostOpen}),
)(App);
